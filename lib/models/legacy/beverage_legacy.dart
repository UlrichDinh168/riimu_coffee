...
class Salesperson {
  ...
  @override
  String toString() {
    return 'Salesperson{name: $name, status: $status}';
  }
...
class DescriptionItem {
  ...
  @override
  String toString() {
    return 'DescriptionItem{category: $category, total: $total, '
        'remain: $remain, degree: $degree, desc: $desc}';
  }
...
class Description {
  ...
  @override
  String toString() {
    return 'Description{properties: $properties}';
  }
...
class BeverageSingleItem {
  ...
  @override
  String toString() {
    return 'BeverageSingleItem{title: $title, description: $description, '
        'rating: $rating, star: $star, image: $image}';
  }
...
class Beverage {
  ...
  @override
  String toString() {
    return 'Beverage{id: $id, title: $title, material: $material, types: $types, '
        'salespersons: $salespersons, description: $description, themeImage: $themeImage, '
